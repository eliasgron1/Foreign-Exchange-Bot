...
if(__name__ == "__main__"):
    api = OandaAPI()
    #print(api.fetch_candles("EUR_USD", 10, "1h"))
    #print(api.get_instruments_df())
    #   print(api.fetch_candles("EUR_USD", 10, 'H1'))

    #status, json = api.fetch_candles("EUR_USD", 10, 'H1')
    #print(json)
    
    #print(api.get_candles_df(json))
    
    
    #api.save_instruments()


    #json = api.fetch_candles("EUR_USD", 10, '1h')
    
    #api.get_candles_df(json)
